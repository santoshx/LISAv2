...
Function Main
{
	...
	Configure-VmMemory -VM $VM1 -minMem $tPs.minMem1 -maxMem $tPs.maxMem1 -startupMem $tPs.startupMem1 -memeWeight $tPs.memWeight1
	Configure-VmMemory -VM $VM2 -minMem $tPs.minMem2 -maxMem $tPs.maxMem2 -startupMem $tPs.startupMem2 -memeWeight $tPs.memWeight2
	Configure-VmMemory -VM $VM3 -minMem $tPs.minMem3 -maxMem $tPs.maxMem3 -startupMem $tPs.startupMem3 -memeWeight $tPs.memWeight3
